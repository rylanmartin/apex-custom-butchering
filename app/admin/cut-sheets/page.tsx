...
export default function AdminCutSheetsPage() {
  ...
  const activeSheets = tab === "submitted" ? submitted : printed;
          ...
          <div className="flex flex-col gap-4 border-b border-stone-200 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-2xl font-black uppercase tracking-tight">
                {tab === "submitted" ? "Submitted / Ready to Print" : "Printed Archive"}
              </h2>
              <p className="mt-1 text-sm text-stone-600">
                {tab === "submitted"
                  ? "Customer-submitted sheets that have never been printed."
